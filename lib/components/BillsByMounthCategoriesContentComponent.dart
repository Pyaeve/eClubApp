...
class BillsByMounthCategoriesContentComponent extends StatefulWidget {
  const  BillsByMounthCategoriesContentComponent({super.key, required this.category, required this.mounth});
  final  String mounth;
  final String category;

  @override
  _BillsByMounthCategoriesContentComponentState createState() => _BillsByMounthCategoriesContentComponentState();
}

class _BillsByMounthCategoriesContentComponentState extends State<BillsByMounthCategoriesContentComponent> {
   @override
  void initState() {
    super.initState();
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Padding(                                padding: EdgeInsets.all(14.0),
                                child: Text('Ver Extracto', style: TextStyle(
                                  fontSize: 18
                                ),),
                              ),
                                    ),
