...
class BillsByMounthContentComponent extends StatefulWidget {
  ...
  @override
  _BillsByMounthContentComponentState createState() => _BillsByMounthContentComponentState();
}

class _BillsByMounthContentComponentState extends State<BillsByMounthContentComponent> {
   @override
  void initState() {
    super.initState();
